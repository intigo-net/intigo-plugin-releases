...
<!-- LATEST:START (auto-generated by bin/update-readme-banner.sh — do not edit by hand) -->
> **Latest working versions**
>
> - **PrestaShop** — `v1.3.30` → [`prestashop/v1.3.30/`](prestashop/v1.3.30/)
> - **WordPress / WooCommerce** — `v0.2.11` → [`wordpress/v0.2.11/`](wordpress/v0.2.11/)
<!-- LATEST:END -->
...
- WordPress / WooCommerce plugin package — **latest:** `wordpress/v0.2.11`
...
1. Open `wordpress/v0.2.11/` (latest).
2. Download `wordpress-intigo-parcels-v0.2.11.zip`.
