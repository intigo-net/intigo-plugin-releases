...
> - **WordPress / WooCommerce** — `v0.4.0` → [`wordpress/v0.4.0/`](wordpress/v0.4.0/)
<!-- LATEST:END -->
...
- WordPress / WooCommerce plugin package — **latest:** `wordpress/v0.4.0`
...
1. Open `wordpress/v0.4.0/` (latest).
2. Download `wordpress-intigo-parcels-v0.4.0.zip`.
