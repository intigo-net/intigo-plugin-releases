...
> - **PrestaShop — `v1.3.19`** → [`prestashop/v1.3.19/`](prestashop/v1.3.19/)
> - WordPress / WooCommerce — `v0.2.1` → [`wordpress/v0.2.1/`](wordpress/v0.2.1/)
...
1. Open `prestashop/v1.3.19/` (latest).
2. Download `prestashop-intigo-parcels-v1.3.19.zip`.
