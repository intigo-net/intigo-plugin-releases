...
> - **WordPress / WooCommerce** — `v0.4.4` → [`wordpress/v0.4.4/`](wordpress/v0.4.4/)
<!-- LATEST:END -->
...
- WordPress / WooCommerce plugin package — **latest:** `wordpress/v0.4.4`
...
1. Open `wordpress/v0.4.4/` (latest).
2. Download `wordpress-intigo-parcels-v0.4.4.zip`.
