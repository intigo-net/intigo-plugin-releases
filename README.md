...
> - **WordPress / WooCommerce** — `v0.4.3` → [`wordpress/v0.4.3/`](wordpress/v0.4.3/)
<!-- LATEST:END -->
...
- WordPress / WooCommerce plugin package — **latest:** `wordpress/v0.4.3`
...
1. Open `wordpress/v0.4.3/` (latest).
2. Download `wordpress-intigo-parcels-v0.4.3.zip`.
